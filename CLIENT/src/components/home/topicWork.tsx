  ...
  return (
    <div className="work">
      ...
      <p className="work-desc">
        Nếu đây là lần đầu truy cập, đừng bối rối! tracnghiem.tk cực kỳ đơn giản và dễ sử dụng chỉ
        với vài thao tác
      </p>
        ...
        <div className="row">
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="work-item">
              ...
              <p className="work-item-desc">
                Bạn có thể tự tạo riêng cho mình một tài khoản mới, nếu có bất kì khó khán gì xin
          ...
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="work-item">
              ...
              <p className="work-item-desc">
                Tracnghiem.tk cung cấp cho bạn một ngân hàng đề thi trắc nghiệm đồ sộ mà bạn có thể
                nhanh chóng thử sức với bất kỳ bộ đề nào hứng thú
              </p>
            </div>
          </div>
          <div className="col-xl-4 col-lg-6 col-md-6">
